...
public class ReactWheelCurvedPickerManager extends SimpleViewManager<ReactWheelCurvedPicker> {
    ...
    protected ReactWheelCurvedPicker createViewInstance(ThemedReactContext reactContext) {
        ...
        picker.setSeparatorColor(Color.WHITE);
    ...
    @ReactProp(name="separatorColor", customType = "Color")
    public void setSeparatorColor(ReactWheelCurvedPicker picker, Integer color) {
        if (picker != null) {
            picker.setSeparatorColor(color);
        }
    }
